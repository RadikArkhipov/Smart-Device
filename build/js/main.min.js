...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    function addMask(currentTelInput) {
      window.iMaskJS(currentTelInput, {
        mask: '+{7}(000)000-00-00'
      });
    }
    var currentOpenedSection = '';
    ...
    var showNavBtn = document.querySelector('[data-show-nav]');
    ...
    var showContactsBtn = document.querySelector('[data-show-contacts]');
    ...
    var aboutUs = document.querySelector('[data-about-us]');
    var showAboutBtn = document.querySelector('[data-show-about]');
    var closeAboutBtn = document.querySelector('[data-close-about]');
    ...
    var overlay = document.querySelector('div[data-close-modal]');
    var callBackPopup = document.querySelector('[data-modal="feedback"]');
    var closeButton = callBackPopup.querySelector('button[data-close-modal]');
    var callBackButton = document.querySelector('[data-open-modal]');
    var input = callBackPopup.querySelector('input[type="text"]');
    var formElement = document.querySelector('[data-form="feedback"]');
    var modalForm = callBackPopup.querySelector('[data-form-modal]');
    if (formElement) {
    ...
    if (modalForm) {
      modalForm.addEventListener('submit', function (evt) {
        var telInput = modalForm.querySelector('input[type="tel"]');
        var telValue = telInput.value;
        if (telValue.length < MAX_NUMBERS) {
          evt.preventDefault();
        }
    ...
    var openPopup = function openPopup() {
      ...
      var focusableElements = callBackPopup.querySelectorAll(focusableElementsString);
      Array.prototype.slice.call(focusableElements), _readOnlyError("focusableElements");
    ...
    (function () {
      var writeFormModal = document.querySelector('.write__form--modal input[type="tel"]');
      var phone = document.querySelector('.write__form  input[type="tel"]');
      if (phone) {
        addMask(phone);
      }
      if (writeFormModal) {
